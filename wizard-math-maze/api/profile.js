 ...
 * the only credential: a wrong passcode simply derives a token matching no row,
 * which also means this endpoint can't be used to discover which wizard names
 * exist.
 */
